...
/*
emails)	Имеется прямоугольное отверстие a*b, определить, можно ли его закрыть круглой картонкой радиуса r. a, b, r вводятся с клавиатуры, ответ выводится на клавиатуру.
...
/*
Во второй задаче не надо писать else if (d < c / emails)  , достаточно else.
 */