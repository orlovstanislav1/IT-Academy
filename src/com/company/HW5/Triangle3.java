...
/*
2)	Создать класс Triangle, хранящий три стороны треугольника. Сделать конструктор,
...
/*
2) В задании 2 лучше делать поля private, чтобы соблюдать принцип инкапсуляции. А конструкторы можно было бы
