...
//3.	Пользователь вводит с клавиатуры 2 числа: a - начало и b - конец интервала из целых чисел.
...
public class Main3 {
    public static void main(String[] args) throws Exception {
        ...
        System.out.println ( "Введи с клавиатуры 2 числа:a - начало и b - конец интервала из целых чисел. Выведятся " +
